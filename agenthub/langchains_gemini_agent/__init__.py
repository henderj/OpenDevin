...
import agenthub.langchains_gemini_agent.utils.llm as llm
...
from agenthub.langchains_gemini_agent.utils.monologue import Monologue
from agenthub.langchains_gemini_agent.utils.memory import LongTermMemory
...
class LangchainsGeminiAgent(Agent):
    _initialized = False
...
Agent.register("LangchainsGeminiAgent", LangchainsGeminiAgent)
