...
from agenthub.langchains_gemini_agent.utils.agent import (
    Agent as LangchainsGeminiAgentImpl,
)
...
class LangchainsGeminiAgent(Agent):
    ...
    def _initialize(self):
        ...
        self.agent = LangchainsGeminiAgentImpl(self.instruction, self.model_name)
